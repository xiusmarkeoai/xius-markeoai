    ...
    paths: {
      [pathKey]: {
        get: {
          ...
          responses: {
            "200": {
              description: "A JSON object containing the advertisement destination link and image link for this chatbot",
              content: {
                "application/json": {
                  schema: {
      ...
      schemas: {
        AdContent: {
          ...
          properties: {
            text: {
              type: "string",
              description: "The advertisement text, which may include destination link and image link.",
            },
          },
        },
      },
