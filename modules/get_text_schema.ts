    ...
    paths: {
      [pathKey]: {
        get: {
          ...
          description: "Retrieves advertisement details including destination link and text.",
          parameters: [
            {
              in: "query",
          ...
          responses: {
            "200": {
              description: "A JSON object containing the advertisement destination link and text for this chatbot",
              content: {
                "application/json": {
                  schema: {
      ...
      schemas: {
        AdContent: {
          ...
          properties: {
            text: {
              type: "string",
              description: "The advertisement text, which may include destination link and text.",
            },
          },
        },
      },
